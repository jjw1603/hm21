...
## 과제하면서 느낀점
- 이번 마지막 홈페이지 만들기를하면서 앞에서 배웠던 것들을 사용하면서 만들다보니 시간가는줄 모르면서 만들었던것 같다. 학기중이 아니어도 방학때 한번씩 HTML5에서 배운 내용을 바탕으로 홈페이지를 만들어보고 싶다. HTML5를 사용하면 내가 만들고 싶은것들을 쉽게 만들 수 있을거 같아서 방학때도 열심히 공부를 하고싶다
